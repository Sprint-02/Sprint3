    ...
    arduino.pipe(new serialport.ReadlineParser({ delimiter: '\r\n' })).on('data', async (data) => {
        ...
        if (HABILITAR_OPERACAO_INSERIR) {
            if (AMBIENTE == 'producao') {
                ...
                sqlquery = `INSERT INTO dados( dht11_umidade, lm35_temperatura, fkSensord) VALUES (${dht11Umidade}, ${lm35Temperatura},  1)`;
                ...
                await poolBancoDados.execute(
                    `INSERT INTO dados( dht11_umidade, lm35_temperatura, fkSensord) VALUES (${dht11Umidade}, ${lm35Temperatura},  1)`,
